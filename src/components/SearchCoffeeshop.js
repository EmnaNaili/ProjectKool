...
const SearchCoffeeshop = () => {
   ...
   const refname=useRef();
       ...
       const Coffeeshop = CoffeeshopList.find((item)=>{return item.name == name });
 ...
 <h1 style={{"font-family": "serif", color:'white'}}> Search for your Coffeeshop  </h1>
...
>
 { bool &&  <div className="details">  
      ...
      <Link to={`/description/${Coffeeshop._id}`}>
