...
const SearchLounge = () => {
   ...
   const refname=useRef();
       ...
       const Lounge = LoungeList.find((item)=>{return item.name == name });
 ...
 <h1 style={{"font-family": "serif", color:'white'}}> Search for your Lounge  </h1>
...
>
 { bool &&  <div className="details">  
      ...
      <Link to={`/description/${Lounge._id}`}>
